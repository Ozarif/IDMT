...
public sealed class Resource : Entity
{
	...
	private Resource() { }
	private Resource(Guid id, ResourceType resourceType, Name name, Guid supportGroupId) : base(id)
	{
	...
	public static Resource Create(ResourceType resourceType, Name name, SupportGroup supportGroup)
	{
